...
const TargetSurahCard = ({ surahName, progress, itemVariants }) => {
  ...
  return (
    ...
    >
      <div className="relative h-full min-h-[400px] overflow-hidden bg-card/40 rounded-3xl p-8 sm:p-10 shadow-xl shadow-rose-900/40 border border-white/10 flex flex-col justify-between transition-all duration-500 hover:shadow-rose-900/60 backdrop-blur-md">
        {/* Ruby Accents */}
        ...
        <div className="relative mt-auto pt-8">
          ...
          <div className="h-4 w-full bg-black/30 rounded-full border border-white/5 overflow-hidden shadow-inner">
            <motion.div
              initial={{ width: 0 }}
