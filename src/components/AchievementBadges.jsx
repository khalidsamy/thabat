          ...
          return (
            <motion.div
              ...
              className={`flex-shrink-0 w-44 snap-start p-6 rounded-3xl border transition-all duration-500 relative group ${
                isUnlocked 
                  ? 'bg-gradient-to-br from-white to-gray-50 dark:from-slate-800 dark:to-slate-900 border-amber-500/20 dark:border-amber-500/10 shadow-xl shadow-amber-500/5' 
            ...
            >
              ...
              {isUnlocked && (
                <motion.div 
                  ...
                  className="absolute inset-0 w-1/4 h-full bg-gradient-to-r from-transparent via-white/10 dark:via-white/5 to-transparent z-10 pointer-events-none"
                />
              )}
              ...
              <div className="flex flex-col items-center text-center gap-4 relative z-20">
                ...
                <div>
                  <h4 className={`text-sm font-bold truncate px-2 ${
                    isUnlocked ? 'text-foreground' : 'text-slate-400'
                  }`}>
                    {milestone.title}
                  </h4>
                  <p className="text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest mt-1">
                    {milestone.surah}
                  </p>
                </div>
                ...
                {!isUnlocked && (
                    <div className="w-full mt-2">
                        <div className="flex justify-between text-[8px] mb-1 font-bold text-slate-400">
