...
const FloatingAssistantMenu = () => {
  ...
  // Navigation Overlay and FAB Content
  const menuContent = (
  ...
  useEffect(() => {
    const corner = isRtl ? 'bottomLeft' : 'bottomRight';
    registerElement(corner, 'assistant-menu', menuContent);
    return () => unregisterElement(corner, 'assistant-menu');
  }, [registerElement, unregisterElement, isRtl, menuContent]);
