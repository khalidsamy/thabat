      ...
      <div className="flex flex-col xl:flex-row gap-8 items-stretch">
        ...
        {dailyVerse && (
          <motion.section 
            ...
            className={`flex-1 mb-10 xl:mb-0 ${progress?.streak === 0 && progress?.totalMemorized > 0 ? 'xl:max-w-md' : 'w-full'}`}
          >
            <div className="relative h-full overflow-hidden bg-gradient-to-br from-emerald-600 to-teal-700 rounded-[2.5rem] p-8 shadow-2xl shadow-emerald-500/20 group border border-white/10">
              ...
              <div className="relative flex flex-col h-full items-center text-center justify-center gap-6">
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <p className="text-xl sm:text-2xl font-bold text-white mb-4 leading-relaxed" dir="rtl">
                    {dailyVerse.arabic}
                  </p>
                  <p className="text-[10px] font-black text-emerald-100/60 uppercase tracking-[0.2em] mb-4" dir="rtl">
                    — {dailyVerse.reference}
                  </p>
                  <p className="text-xs sm:text-sm font-medium text-white/80 italic leading-relaxed max-w-sm mx-auto">
                    {dailyVerse.english}
                  </p>
                </div>
              </div>
